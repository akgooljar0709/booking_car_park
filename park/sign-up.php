            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="sign-in-form-area">
                        <h3 class="title">Welcome to Diveon ! Please login</h3>
                        <form class="sign-in-form" action="action_login.php" method="POST">
                            <?php
                  ...
                  ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email03"
                                    placeholder="Enter your phone number or email">
                            </div>
                            <div class="form-group">
                                <label for="pass02">Password</label>
                                <div class="pass-item">
                                    <input type="password" name="password" id="pass02" placeholder="Please enter your password">
                ...
                <div class="col-md-6">
                    <div class="different-sign-in">
                        ...
                        <form class="sign-in-form" action="action_register.php" method="POST">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="pass02" style = "color:white;">Password</label>
                                <div class="pass-item">
                                    <input type="password" name="password" id="pass02" placeholder="Please enter your password">
                                    <span class="view-pass" id="view-pass-02">
                                        <i class="flaticon-eye"></i>
                            ...
                            <div class="form-group">
                                ...
                                <p class="mt-2"><a href="sign-up.html">Already Register? Sign in</a></p>
                            </div>
                        </form>
                    </div>
                </div>
